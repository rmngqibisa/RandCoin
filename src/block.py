...
class Block:
    ...
    def calculate_hash(self) -> str:
        ...
        block_content = {
            ...
            "transactions": [t.to_dict(copy=True) for t in self.transactions]
        }
    ...
    def mine(self, difficulty: int):
        ...
        # ⚡ Bolt Optimization: Use byte string formatting and hoist hashlib.sha256
        # Escape '%' characters in the suffix to avoid format string errors during interpolation.
